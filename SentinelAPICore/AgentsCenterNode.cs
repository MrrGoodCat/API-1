...
{
    public class AgentsCenterNode : NICEPmNodeBase
    {
        //metric names
        ...
        /// The m metric list.
        /// </summary>
        private static List<NICEMetric> mMetricList;

        /// <summary>
        /// The log trace.
        /// </summary>
        private static IApplicationLogEx LogTrace = ApplicationLogEx.GetDefaultLogger(Assembly.GetExecutingAssembly());

        /// <summary>
        /// The agents.
        /// </summary>
        private List<AgentCurrentStatus> agents = new List<AgentCurrentStatus>();

        /// <summary>
        /// Initializes static members of the <see cref="AgentsCenterNode"/> class.
        /// </summary>
        static AgentsCenterNode()
        {
            //fill the metric list
            mMetricList = NpsUtility.GetMetricsByComponentName("AgentsCenter");
        }
        ...
        /// <summary>
        /// The publish collected data.
        /// </summary>
        /// <param name="publishedMetricsList">
        /// The published metrics list.
        /// </param>
        /// <returns>
        /// The <see cref="bool"/>.
        /// </returns>
        public override bool PublishCollectedData(ref List<PublishedMetricValue> publishedMetricsList)
        {
            bool success;
            MetricValueWithStatus res = new MetricValueWithStatus(null, MetricCollectionStatus.FailedToCollect);
            LogTrace.WriteTraceFormatted("AgentsCenterPoller: Attempting publishing metrics for {0}", NodeServer.IPAddr);
            try
            {
                ...
                string endpoint = "http://" + NodeServer.IPAddr + ":62124/AgentsCenter.Information.AgentsMonitoring.IAgentsMonitoringStatusService";
            ...
            if (!success)
            {
                this.AddAllMetricsToFailed(mMetricList, res.ErrorMessage, res.ErrorReason);
            }
